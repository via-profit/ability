...
- [Управление политиками](#управление-политиками)
  ...
  - [Wildcard в действиях](#wildcard-в-действиях)
...
- политик много,
- они относятся к разным действиям,
- некоторые используют wildcard (`order.*`, `*.create`).
...
- задавать общие правила (`order.*`),
- переопределять их более специфичными (`order.update`),
- накладывать «вето» на ранее разрешённые действия.
