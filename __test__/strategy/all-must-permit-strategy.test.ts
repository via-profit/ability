...
import AllMustPermitStrategy from '../../src/strategy/AllMustPermitStrategy';
...
`;
describe('AllMustPermitStrategy: permission.client.delete', () => {
  const policies = new AbilityDSLParser(dsl).parse();
  const resolver = new AbilityResolver(policies, AllMustPermitStrategy);
