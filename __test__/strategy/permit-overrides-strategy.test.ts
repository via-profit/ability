...
describe('PermitOverridesStrategy: permission.client.delete', () => {
  ...
  // 1. Admin
  //
  test('admin can delete any client (permit wins)', () => {
  ...
  // 2. Manager
  //
  test('manager CAN delete ООО/ПАО/ОАО (permit overrides deny)', () => {
  ...
  test('manager can delete other clients (permit)', () => {
    const user = makeUser('manager');
  ...
  // 3. Dispatcher
  //
  test('dispatcher CAN delete old IP (permit overrides deny)', () => {
  ...
  test('dispatcher can delete fresh IP (permit)', () => {
    const user = makeUser('dispatcher');
  ...
  // 4. Operator
  //
  test('operator CAN delete blocked clients (permit overrides deny)', () => {
  ...
  test('operator can delete unblocked clients (permit)', () => {
    const user = makeUser('operator');
