...
Политика — это основной блок системы. Она определяет, какое ключ разрешения над каким ресурсом и при каких условиях разрешено или запрещено.
...
- `user.delete` — ключ разрешения, к которому применяется правило
...
## `Ключ разрешения` (permission) политики

TODO: Дописать про ключ разрешения политики (permission)
